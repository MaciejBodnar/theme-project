<footer class="text-white snap-normal snap-align-none md:snap-always md:snap-center" style="--gold: #d1b07a;">
    ...
    <section class="bg-black border-t border-white/10">
        <div class="container mx-auto px-4 py-6">
            <div class="flex items-center justify-center gap-8 md:gap-20 lg:gap-40">
                ...
                <a href="{{ $footer['social']['linkedin_url'] }}" aria-label="LinkedIn"
                    class="hover:text-[var(--gold)] transition p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12"
                        fill="currentColor"
                ...
                <a href="{{ $footer['social']['youtube_url'] }}" aria-label="YouTube"
                    class="hover:text-[var(--gold)] transition p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12"
                        fill="currentColor"
                        viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.-->
    ...
    <section class="bg-[#0b0b0b]">
        <div class="container mx-auto px-4 py-8 md:py-12 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 text-sm">
            ...
            <div class="text-center md:text-left">
                ...
                <p class="mt-3 text-white/70 leading-relaxed">
                    <span
                        class="hover:text-white transition-colors block mb-1">{{ $footer['contact']['contact_info']['email'] }}</span>
                    <span
                        class="hover:text-white transition-colors block">{{ $footer['contact']['contact_info']['phone'] }}</span>
                </p>
            </div>
        </div>
        <div
